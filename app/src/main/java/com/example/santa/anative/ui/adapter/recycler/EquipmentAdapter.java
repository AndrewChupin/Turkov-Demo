...
import com.example.santa.anative.entity.Equipment;
import com.example.santa.anative.view.activity.EquipmentActivity;
import com.example.santa.anative.view.activity.ScheduleActivity;
import com.example.santa.anative.view.activity.SettingEquipmentActivity;
...
public class EquipmentAdapter extends RecyclerView.Adapter<EquipmentAdapter.EquipmentViewHolder> {
    ...
    class EquipmentViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.switch_equipment_item_switcher) SwitchCompat mSwitcher;
